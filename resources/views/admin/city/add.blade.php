...
<h1>Add City</h1>
    <form method="POST" action="{{ url('admin/city/add') }}">
        @csrf
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" name="city_name" id="staticEmail">
    </div>
  </div>
  <br>
    <div class="form-group row">
            ...
            if ($countryId) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#state').empty().append('<option value="">Select State Name</option>');
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $('#state').empty().append('<option value="">Unable to load states</option>');
                    }
                });
            } else {
